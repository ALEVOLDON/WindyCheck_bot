...
* 🌐 **[Инструкция пользователя (English HTML)](Wind_Tracker_Bot_Instruction.en.html)** — интерактивная веб-инструкция на английском языке.
* 📄 **[Инструкция пользователя (Russian DOCX)](Wind_Tracker_Bot_Instruction.docx)** — документ в формате MS Word.
* 🌐 **[Инструкция пользователя (Russian HTML)](Wind_Tracker_Bot_Instruction.html)** — веб-страница справки на русском языке.
